...
class CoreCharEntity : public CoreEntity
{
    public:
        int health;
        float speed;
        CoreCharEntity(EntityRig entRig, int health, std::vector<CoreEntity>* collidables ,glm::vec3 pos = glm::vec3{0.0f, 0.0f, 0.0f}, glm::vec3 orient = glm::vec3{0.0f, 0.0f, 1.0f});
